window.onload = function () {
    ...
    var tvShowsArray = ["Friday Night Lights", "Dexter", "Castle Rock", "Desperate Housewives", "Homeland", "Family Guy", "It's always Sunny in Philedelphia", "The Handmaid's Tale", "Game of Thrones", "Queer as Folk", "Breaking Bad", "Orange is the New Black", "The Vampire Diaries", "That 70's Show", "Weeds", "Law & Order", "Wayward Pines", "Parks and Rec", "Friends", "The Office", "Roseanne", "Full House"];
    ...
    function generateGif() {
        ...
        $.ajax({
            ...
            for (var i = 0; i < numberOfGifs; i++) {
                ...
                var gifDiv = $("<div>");
                gifDiv.addClass("gifContainer col-md-6 p-0");
